...
; The file to write
OutFile "Plugin_VariousStuff_${VERSION}.exe"
...
; Sections
Section "VariousStuff" SEC_PLUGIN
    SectionIn RO
        
    SetOutPath "$INSTDIR\Bin32\Plugins\VariousStuff"
    ;File "${FILES_ROOT}\..\..\Bin32\Plugins\VariousStuff\Plugin_VariousStuff.dll"
	File "${FILES_ROOT}\..\..\Bin32\Plugins\VariousStuff\*.dll"

    SetOutPath "$INSTDIR\Bin64\Plugins\VariousStuff"
    ;File "${FILES_ROOT}\..\..\Bin64\Plugins\VariousStuff\Plugin_VariousStuff.dll"
    File "${FILES_ROOT}\..\..\Bin64\Plugins\VariousStuff\*.dll"

	; Standard Code directory also used in git repo
    SetOutPath "$INSTDIR\Code\Plugin_VariousStuff"
...
Section "Interface Headers" SEC_INTERFACE
    SetOutPath "$INSTDIR\Code\Plugin_VariousStuff\inc"
...
; Set Fileinfos
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "VariousStuff Plugin"
VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalCopyright" "Copyright (c) 2013, The authors of the VariousStuff Plugin project"
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "VariousStuff Plugin for CryEngine"
...
Function "ShowChangelog"
	Exec 'notepad "$INSTDIR\Code\Plugin_VariousStuff\changelog.md"'
FunctionEnd
