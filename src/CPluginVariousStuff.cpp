...
namespace VariousStuffPlugin
{
    ...
    CPluginVariousStuff::CPluginVariousStuff()
    {
        gPlugin = this;
    }
    ...
    bool CPluginVariousStuff::Release( bool bForce )
    {
        bool bRet = true;
    ...
    bool CPluginVariousStuff::Init( SSystemGlobalEnvironment& env, SSystemInitParams& startupParams, IPluginBase* pPluginManager, const char* sPluginDirectory )
    {
    ...
    bool CPluginVariousStuff::RegisterTypes( int nFactoryType, bool bUnregister )
    {
    ...
    const char* CPluginVariousStuff::ListCVars() const
    {
        return "..."; // TODO: Enter CVARs/Commands here if you have some
    }

    const char* CPluginVariousStuff::GetStatus() const
    {
        return "OK";
    }
